    ...
    <div className="home-bg">
      ...
      <main className="home-main">  
        <section className="home-left">
          <div className="home-title" ref={titleRef}>AI & ML Engineer / Data Analyst</div>
          <h1>
          ...
          <div className="home-actions" ref={actionsRef}>
            <a href="/media/Roshan_Varghese_Data_Analyst.pdf" className="resume-btn" target="_blank" rel="noopener noreferrer">
